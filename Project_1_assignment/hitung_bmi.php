        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="card card-info">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="data_bmi.php" method="post" class="form-horizontal">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="berat_badan" class="form-control" placeholder="Masukan Berat Badan">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" name="tinggi_badan" class="form-control" placeholder="Masukan Tinggi Badan">
                                </div>
                            </div>
